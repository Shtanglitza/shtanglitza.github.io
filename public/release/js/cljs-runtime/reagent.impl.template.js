...
var G__21598 = o;
reagent.impl.template.goog$module$goog$object.set(G__21598,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null, v)));
...
while (G__21722__i < G__21722__a.length) {G__21722__a[G__21722__i] = arguments[G__21722__i + 0]; ++G__21722__i;}
  args = new cljs.core.IndexedSeq(G__21722__a,0,null);
} 
...
var args = cljs.core.seq(arglist__21723);
...
var G__21604 = o;
reagent.impl.template.goog$module$goog$object.set(G__21604,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__21724__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__21725__i < G__21725__a.length) {G__21725__a[G__21725__i] = arguments[G__21725__i + 0]; ++G__21725__i;}
  args = new cljs.core.IndexedSeq(G__21725__a,0,null);
} 
return G__21724__delegate.call(this,args);};
...
return G__21724__delegate(args);
});
...
var G__21605 = props;
var G__21605__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21605,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__21605);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21605__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__21606 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21606,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__21606;
}
})(),id_class);
...
var G__21607 = (cljs.core.count(argv) - first_child);
switch (G__21607) {
case (0):
...
var vec__21615 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21615,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21615,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21615,(2),null);
...
var temp__5808__auto___21728 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___21728 == null)){
} else {
var key_21729 = temp__5808__auto___21728;
(jsprops.key = key_21729);
}
...
var temp__5808__auto___21730 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___21730 == null)){
} else {
var key_21731 = temp__5808__auto___21730;
...
var temp__5808__auto___21732 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___21732 == null)){
} else {
var key_21733 = temp__5808__auto___21732;
...
var temp__5808__auto___21746 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___21746 == null)){
} else {
var key_21748 = temp__5808__auto___21746;
(jsprops.key = key_21748);
}
...
var temp__5808__auto___21749 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___21749 == null)){
} else {
var key_21750 = temp__5808__auto___21749;
(jsprops.key = key_21750);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__21663_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__21663_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__21671 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21671,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21671,(1),null);
...
break;
default:
var G__21760 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__21761 = compiler;
v = G__21760;
compiler = G__21761;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template21704 = (function (opts,id,fn_to_element,parse_fn,meta21705){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template21704.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_21706,meta21705__$1){
var self__ = this;
var _21706__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template21704(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta21705__$1));
}));

(reagent.impl.template.t_reagent$impl$template21704.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_21706){
var self__ = this;
var _21706__$1 = this;
return self__.meta21705;
}));

(reagent.impl.template.t_reagent$impl$template21704.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template21704.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template21704.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template21704.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template21704.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template21704.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta21705","meta21705",1727042426,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template21704.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template21704.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template21704");

(reagent.impl.template.t_reagent$impl$template21704.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template21704");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template21704.
 */
reagent.impl.template.__GT_t_reagent$impl$template21704 = (function reagent$impl$template$__GT_t_reagent$impl$template21704(opts,id,fn_to_element,parse_fn,meta21705){
return (new reagent.impl.template.t_reagent$impl$template21704(opts,id,fn_to_element,parse_fn,meta21705));
});
...
return (new reagent.impl.template.t_reagent$impl$template21704(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
